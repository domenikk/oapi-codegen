...
//go:generate go run github.com/domenikk/oapi-codegen/cmd/oapi-codegen --config=models.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/domenikk/oapi-codegen/cmd/oapi-codegen --config=server.cfg.yaml ../../petstore-expanded.yaml
...
import (
	...
	"github.com/domenikk/oapi-codegen/examples/petstore-expanded/echo/api/models"
