...
directory does a lot of that for you. You would run it like so:
    ...
    go install github.com/domenikk/oapi-codegen/cmd/oapi-codegen@latest
...
import (
	...
	"github.com/domenikk/oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/domenikk/oapi-codegen/pkg/gin-middleware"
)
...
```go
    import (
        "github.com/domenikk/oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/domenikk/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  embedded-spec: true
import-mapping:
  ./packageA/spec.yaml: github.com/domenikk/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/domenikk/oapi-codegen/internal/test/externalref/packageB
output: externalref.gen.go
output-options:
  skip-prune: true
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/domenikk/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48) 
...
let's call it `github.com/domenikk/some-package`. You need to tell `oapi-codegen` that
`some_spec.yaml` corresponds to this package, and you would do it by specifying
this command line argument:

    -import-mapping=./some_spec.yaml:github.com/domenikk/some-package

This tells us that in order to resolve references generated from `some_spec.yaml` we
need to import `github.com/domenikk/some-package`. You may specify multiple mappings
