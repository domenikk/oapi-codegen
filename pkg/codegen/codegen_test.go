...
import (
	...
	examplePetstoreClient "github.com/domenikk/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/domenikk/oapi-codegen/examples/petstore-expanded/echo/api"
	"github.com/domenikk/oapi-codegen/pkg/util"
...
const (
	...
	remoteRefImport = `github.com/domenikk/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/domenikk/oapi-codegen/examples/petstore-expanded"`)
